...
$pageMod.PageMod({
  ...
  onAttach: function(worker) {
    ...
    switch($simplePrefs.prefs["preferences.unreadNotificationType"]) {
      ...
      default: {
        console.error("notifyr", "main", "Invalid preferences.unreadNotificationType value");
        self.port.emit("notifyr.error", "Invalid preferences.unreadNotificationType value");
        break;
      }
    }
